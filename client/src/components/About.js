...
const About = props => {
    return (
        <div id='about'>
            ...
            <h4><mark>To write well is to think clearly.</mark></h4>

            <h4>Unfortunately, many forces stand in our way when we seek to write.</h4>
                
            <h4>Perhaps the most pernicious of these foes is the very act of taking time to do the deed. Our minds conjure endless tasks to lure us away: work emails await our reply, the kids need to be put to bed, the dog must go out.</h4>

            <h4>But if we could just carve out the time to write, we'd find ourselves creating the space to let our best thoughts unfold.</h4>

            <h4>Prosescript will help you clear those early barriers to writing by freeing you from a blog editor. This means you can write anywhere: a word processor, a mobile note-taking app, even an email draft. No matter where you write, Prosescript will accept your writing in an email and convert it into a Medium post.</h4>

            <h4>Ultimately, Prosescript is here to help you think better by making writing easier. All you need to <a className='href' href={props.signup}>get started</a> is a Medium account and an email address.</h4>
