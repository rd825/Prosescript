...
const About = props => {
    return (
        <div id='about'>
            ...
            <h4>Prosescript will help you think better by making writing easier. All you need to <a className='href' href={props.signup}>get started</a> is a Medium account and an email address.</h4>
